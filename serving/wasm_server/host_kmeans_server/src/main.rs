...
async fn main() -> Result<()> {
    ...
    println!("Starting COMET-Wasm K-Means Wasmtime Server");

    let engine = Engine::default();

    let module_path =
        "../../../wasm/tenant_kmeans_real/target/wasm32-unknown-unknown/release/tenant_kmeans_real.wasm";
    ...
    println!("K-Means Wasm module loaded");
    ...
    println!("Wasm K-Means server listening on http://{}", addr);
